...
// CGRAM 地址 0x00: Grass Frame 0
const uint8_t char_grass_f0[8] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x03, 0x03
};

// CGRAM 地址 0x01: Grass Frame 1
const uint8_t char_grass_f1[8] = {
	0x00, 0x00, 0x00, 0x02, 0x07, 0x07, 0x0F, 0x0F
   };

// CGRAM 地址 0x02: Grass Frame 2
const uint8_t char_grass_f2[8] = {
    0x00, 0x00, 0x00, 0x10, 0x18, 0x18, 0x1C, 0x1C
};

// CGRAM 地址 0x03: Grass Frame 3
const uint8_t char_grass_f3[8] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x10
};

// CGRAM 地址 0x04: Dino Run/Stand Frame A (图像左上)
const uint8_t char_dino_04[8] = {
	0x00, 0x00, 0x00, 0x0E, 0x1F, 0x15, 0x1F, 0x0E
};

// CGRAM 地址 0x05: Dino Run/Stand Frame B (图像右上)
const uint8_t char_dino_05[8] = {
	0x00, 0x00, 0x00, 0x04, 0x0E, 0x1F, 0x15, 0x1F
};

// CGRAM 地址 0x06: Dino Jump Top (图像左下，大部分为空，用于高位)
const uint8_t char_dino_06[8] = {
	0x1F, 0x0E, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00
};

// CGRAM 地址 0x07: Dino Jump Mid (图像右下)
const uint8_t char_dino_07[8] = {
	0x00, 0x0E, 0x15, 0x1F, 0x0E, 0x00, 0x00, 0x00
};

// 定义自定义字符数组的集合
const uint8_t *custom_chars[] = {
	char_grass_f0, char_grass_f1, char_grass_f2, char_grass_f3,
	char_dino_04, char_dino_05, char_dino_06, char_dino_07
};
...
void lcd_write(Lcd_HandleTypeDef * lcd, uint8_t data, uint8_t len)
{
	...
	volatile uint32_t delay_count = 30000;
	while(delay_count--);
}
